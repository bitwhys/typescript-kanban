...
const Sidebar = ({ isHidden, onHide }: SidebarProps) => {
  return (
    <div
      id="side-nav"
      className={clsx('z-10 w-72 flex-col border-r-2 border-grey-100 bg-white pb-8', isHidden ? 'hidden' : 'flex')}
    >
      {/* BRAND */}
